        ...
        <div class="col-md-6 " id="bcpl">
          <div class="d-flex align-items-centers justify-content-center">
            ...
            <input type="radio" name="penempatan" id="cm"
              <?php echo ($penempatan == "BCPL Billet Casting" ? 'checked="chechked"' : "") ?> class=" ml-2"
              value="BCPL Billet Casting" style="width:25px; height:25px;cursor:pointer" required>
          </div>

          <div class="d-flex align-items-centers justify-content-center">
            <label for="fc">Bilet Handling</label>
            <input type="radio" name="penempatan" id="fc"
              <?php echo ($penempatan == "BCPL Billet Handling" ? 'checked="chechked"' : "") ?> class=" ml-2"
              value="BCPL Billet Handling" style="width:25px; height:25px;cursor:pointer">
          </div>
          <div class="d-flex align-items-centers justify-content-center">
          ...
          <div class="d-flex align-items-centers justify-content-center">
            ...
            <input type="radio" name="penempatan" id="sw"
              <?php echo ($penempatan == "BCPL Billet Sawing" ? 'checked="chechked"' : "") ?> class=" ml-2"
              value="BCPL Billet Sawing" style="width:25px; height:25px;cursor:pointer">
          </div>
        </div>
      </div>
    </div>
